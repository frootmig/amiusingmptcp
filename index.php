...
<html>
	...
	<body>
			...
			else
			{
				...
				switch (get_platform())
				{
					...
					case OS_ANDROID:
						...
						break;
					case OS_IPHONE:
						echo "<p><span class=\"bold red\">NO</span>, sorry, but MPTCP is currently unavailable on iOS!  Check again another time!</p>\n";
						break;
					default:
		...
		<br />
		<hr />
		<span class="small"><a href="http://mdlayher.com/" title="Matt Layher">Matt Layher</a>, 2013 | <a href="https://github.com/mdlayher/amiusingmptcp" title="Am I using MPTCP? on GitHub">GitHub</a></span>
	</body>
</html>
